...
<html lang="en">
    <head>
        ...
        <?php require('views/_required_css.html'); ?>
    </head>
    ...
    <body class="auth-body-bg">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-0 mb-md-0">
                                        <a href="index.php" class="d-block auth-logo">
                                            <img src="./assets/images/default/default-login-logo.png" alt="logo" style="max-height: 50px" class="auth-logo-dark">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        <div>
                                            <h5 class="text-primary">Sign in to your account</h5>
                                            <p class="text-muted">Enter your username & password to login</p>
                                        </div>
                                        <div class="mt-4">
        ...
        <?php require('views/_script.html'); ?>
