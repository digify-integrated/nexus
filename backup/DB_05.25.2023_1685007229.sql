...
INSERT INTO `upload_settings` VALUES (1,'test2','test2',10,1);
...
CREATE TABLE `upload_settings_file_extension` (
  ...
  KEY `upload_settings_file_extension_index_id` (`upload_setting_file_extension_id`),
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `duplicate_upload_settings_file_extension` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `duplicate_upload_settings_file_extension`(IN p_upload_setting_id INT(10))
BEGIN
...
-- Dump completed on 2023-05-25 17:33:50
